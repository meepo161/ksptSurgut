...
import ru.avem.ksptamur.model.phase1.Experiment3ModelPhase1;
...
public class Experiment3ControllerPhase1 extends DeviceState implements ExperimentController {
    ...
    @FXML
    private TableView<Experiment3ModelPhase1> tableViewExperiment3;
    @FXML
    private TableColumn<Experiment3ModelPhase1, String> tableColumnUBH;
    @FXML
    private TableColumn<Experiment3ModelPhase1, String> tableColumnUHH;
    @FXML
    private TableColumn<Experiment3ModelPhase1, String> tableColumnF;
    @FXML
    private TableColumn<Experiment3ModelPhase1, String> tableColumnT;
    @FXML
    private TableColumn<Experiment3ModelPhase1, String> tableColumnResult;
    @FXML
    ...
    public void initialize() {
        setTheme(root);
        experiment3ModelPhase1 = mainModel.getExperiment3ModelPhase1();
        experiment3Data.add(experiment3ModelPhase1);
    ...
    private void fillProtocolExperimentFields() {
        ...
        currentProtocol.setE3UBH(experiment3ModelPhase1.getUBH());
        currentProtocol.setE3UHH(experiment3ModelPhase1.getUHH());
        currentProtocol.setE3F(experiment3ModelPhase1.getF());
        currentProtocol.setE3Result(experiment3ModelPhase1.getResult());
    }
    ...
    private void startExperiment() {
        ...
        experiment3ModelPhase1.clearProperties();
        ...
        new Thread(() -> {
            System.out.println("частота :" + fParma);
            ...
            if (isExperimentRunning && isStartButtonOn && isDevicesResponding()) {
                if (UBHTestItem < WIDDING400) {
                    ...
                    regulation(5 * VOLT, 30, 5, UBHTestItem, 0.1, 2, 100, 200);
                } else if (UBHTestItem > WIDDING400) {
                    appendOneMessageToLog("Поднимаем напряжение до " + UBHTestItem);
                    regulation(5 * VOLT, 30, 5, UBHTestItem, 0.1, 2, 100, 200);
                }
            ...
            if (!cause.equals("")) {
                ...
                experiment3ModelPhase1.setResult("Неуспешно");
            } else if (!isDevicesResponding()) {
                appendMessageToLog(getNotRespondingDevicesString("Испытание прервано по причине: потеряна связь с устройствами"));
                experiment3ModelPhase1.setResult("Неуспешно");
            } else {
                experiment3ModelPhase1.setResult("Успешно");
                ...
                switch (param) {
                    ...
                    case PM130Model.V1_PARAM:
                        if (isNeedToRefresh) {
                            ...
                            if (measuringUOutAB > 0.001) {
                                experiment3ModelPhase1.setUHH(UOutAvr);
                                sleep(50);
                            }
                        }
                        break;
