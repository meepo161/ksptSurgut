...
import ru.avem.ksptamur.model.phase3.Experiment8ModelPhase3;
...
public class Experiment8ControllerPhase3 extends DeviceState implements ExperimentController {
    ...
    @FXML
    private TableView<Experiment8ModelPhase3> tableViewExperiment8;
    @FXML
    private TableColumn<Experiment8ModelPhase3, String> tableColumnType;
    @FXML
    private TableColumn<Experiment8ModelPhase3, String> tableColumnU;
    @FXML
    private TableColumn<Experiment8ModelPhase3, String> tableColumnI;
    @FXML
    private TableColumn<Experiment8ModelPhase3, String> tableColumnTime;
    @FXML
    private TableColumn<Experiment8ModelPhase3, String> tableColumnResult;
    @FXML
    ...
    private Experiment8ModelPhase3 experiment8ModelPhase3BH;
    private Experiment8ModelPhase3 experiment8ModelPhase3HH;
    private ObservableList<Experiment8ModelPhase3> experiment8Data = FXCollections.observableArrayList();
    ...
    public void initialize() {
        setTheme(root);
        experiment8ModelPhase3BH = mainModel.getExperiment8ModelPhase3BH();
        experiment8ModelPhase3HH = mainModel.getExperiment8ModelPhase3HH();
        experiment8Data.add(experiment8ModelPhase3BH);
        experiment8Data.add(experiment8ModelPhase3HH);
    ...
    private void fillProtocolExperimentFields() {
        ...
        currentProtocol.setE8TypeBHandCorps(experiment8ModelPhase3BH.getType());
        currentProtocol.setE8UBHandCorps(experiment8ModelPhase3BH.getUIN());
        currentProtocol.setE8IBHandCorps(experiment8ModelPhase3BH.getIBH());
        currentProtocol.setE8TimeBHandCorps(experiment8ModelPhase3BH.getTime());
        currentProtocol.setE8ResultBHandCorps(experiment8ModelPhase3BH.getResult());

        currentProtocol.setE8TypeHHandCorps(experiment8ModelPhase3HH.getType());
        currentProtocol.setE8UHHandCorps(experiment8ModelPhase3HH.getUIN());
        currentProtocol.setE8IHHandCorps(experiment8ModelPhase3HH.getIBH());
        currentProtocol.setE8TimeHHandCorps(experiment8ModelPhase3HH.getTime());
        currentProtocol.setE8ResultHHandCorps(experiment8ModelPhase3HH.getResult());
    }
    ...
    private void handleStartExperiment() {
        if (isExperimentEnd || !isExperimentStart) {
            startExperiment();
        } else {
            stopExperiment();
        }
    ...
    private void startExperiment() {
        ...
        experiment8ModelPhase3BH.clearProperties();
        experiment8ModelPhase3HH.clearProperties();
    ...
    private void startBH() {
        ...
        if (isExperimentStart && isStartButtonOn && isDevicesResponding()) {
            ...
            communicationModel.onKM8M1Discharge();
            communicationModel.onKM4TPBB();
        }
        ...
        while (isExperimentStart && isStartButtonOn && isDevicesResponding() && (experimentTime-- > 0)) {
            ...
            experiment8ModelPhase3BH.setTime(String.valueOf(experimentTime));
        }
        experimentTime = 60;
        experiment8ModelPhase3BH.setTime(String.valueOf(experimentTime));
        currentStage = 3;
        ...
        if (!cause.equals("")) {
            ...
            experiment8ModelPhase3BH.setResult("Неуспешно");
    ...
    private void startHH() {
        ...
        while (isExperimentStart && isStartButtonOn && isDevicesResponding() && (experimentTime-- > 0)) {
            sleep(1000);
            appendOneMessageToLog("Ждем 60 секунд");
            experiment8ModelPhase3HH.setTime(String.valueOf(experimentTime));
        }
        experimentTime = 60;
        experiment8ModelPhase3HH.setTime(String.valueOf(experimentTime));
        currentStage = 3;
        ...
        if (!cause.equals("")) {
            appendMessageToLog(String.format("Испытание прервано по причине: %s", cause));
            experiment8ModelPhase3HH.setResult("Неуспешно");
        } else if (!isDevicesResponding()) {
            appendMessageToLog(getNotRespondingDevicesString("Испытание прервано по причине: потеряна связь с устройствами"));
            experiment8ModelPhase3HH.setResult("Неуспешно");
        } else {
            experiment8ModelPhase3HH.setResult("Успешно");
...
//                break;
    ...
    private void setU(double value) {
        ...
        switch (currentStage) {
            case 1:
                experiment8ModelPhase3BH.setUIN(String.valueOf(measuringUIn));
                break;
            case 2:
                experiment8ModelPhase3HH.setUIN(String.valueOf(measuringUIn));
                break;
        }
    }
    ...
    private void setI(double value) {
        ...
        switch (currentStage) {
            case 1:
                ...
                break;
            case 2:
                experiment8ModelPhase3HH.setIBH(String.valueOf(iA));
                break;
        }
        if (iA > 1000.0) {
            cause = "ток превысил";
