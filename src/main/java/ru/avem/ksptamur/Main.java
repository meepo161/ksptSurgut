...
//        }
    ...
    private void createLoginScene() throws IOException {
        ...
        loginScene = new Scene(loginWindowParent, ru.avem.ksptamur.Constants.Display.WIDTH, ru.avem.ksptamur.Constants.Display.HEIGHT);
    ...
    private void createMainViewScene() throws IOException {
        ...
        mainViewScene = new Scene(mainViewParent, ru.avem.ksptamur.Constants.Display.WIDTH, ru.avem.ksptamur.Constants.Display.HEIGHT);
