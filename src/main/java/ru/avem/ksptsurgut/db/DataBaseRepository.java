...
public abstract class DataBaseRepository {
    ...
    public static void init(boolean forceInit) {
        if (!new File(DATABASE_NAME).exists() || forceInit) {
            ...
            TestItem testItem1 = new TestItem("500В", 500.0, 220.0, 2.0, 32.0, 4.0, 60.0, 1500);
            TestItemRepository.insertTestItem(testItem1);
            TestItemRepository.insertTestItem(new TestItem("1000В", 1000.0, 220.0, 2.0, 32.0, 4.0, 60.0, 1500));
