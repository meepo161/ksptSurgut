...
package ru.avem.ksptsurgut.communication.serial.driver;
...
abstract class CommonUsbSerialPort implements UsbSerialPort {
    ...
    // non-null when open()
    protected UsbPipe inputPipe = null;
    protected UsbPipe outputPipe = null;
    ...
    public String toString() {
        return String.format("<%s device_name=%s device_id=%s port_number=%s>",
                ...
                "mDevice.getDeviceId()", portNumber);
    }
    ...
    @Override
    public abstract int read(final byte[] dest, final int timeoutMillis) throws IOException, UsbException;
