...
public class ExperimentValuesModel {
    ...
    private Experiment2ModelPhase3 experiment2ModelPhase3BH = new Experiment2ModelPhase3("BH1");
    ...
    private Experiment3ModelPhase3 experiment3ModelPhase3 = new Experiment3ModelPhase3("BH1");
